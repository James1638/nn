...
# June 03 2020
# implemented momentum and annealing
# got up to 0.94685 on the leaderboard https://www.kaggle.com/c/digit-recognizer/leaderboard
# I could experiment with the momentum coefficient and how I loop through the training data,
# but I think my time might be better spent elsewhere.
# Also, I had tried using two hidden layers, but ran into vanishing gradient issues and it
# didn't seem promising for getting a better score.
